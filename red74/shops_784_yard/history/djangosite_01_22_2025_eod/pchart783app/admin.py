...
from .models import Survey, Answer, QuestionAnswer, choice_tbl, PartNumber
...
class SurveyAdmin(admin.ModelAdmin):
    ...
    ordering = ('-created_at',)
    filter_horizontal = ('part_numbers',)  

    class Media:
        css = {
            'all': ('/static/surveyapp/css/custom_admin.css',)
        }
        js = ('/static/surveyapp/js/json_editor_maximize.js',)
...
class QuestionAnswerAdmin(admin.ModelAdmin):
    list_display = (
        'id', 'survey','question_name', 'answer', 'user', 'question_id', 'question_text', 'response',
