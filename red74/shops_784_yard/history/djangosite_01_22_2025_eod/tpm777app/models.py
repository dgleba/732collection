...
class Survey(CommonFields):
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='tpm777app_surveys')
    ...
    part_numbers = models.ManyToManyField('PartNumber', blank=True, related_name='surveys')
...
class Answer(CommonFields):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='tpm777app_answers')
...
class QuestionAnswer(CommonFields):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='tpm777app_questionanswers')
    survey = models.ForeignKey(Survey, on_delete=models.CASCADE)
