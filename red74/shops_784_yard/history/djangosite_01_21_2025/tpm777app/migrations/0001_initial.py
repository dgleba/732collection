    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('part_numbers', models.ManyToManyField(blank=True, related_name='surveys', to='tpm777app.partnumber')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tpm777app_surveys', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('answer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='question_answers', to='tpm777app.answer')),
                ('survey', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tpm777app.survey')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tpm777app_questionanswers', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='answer',
            name='survey',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tpm777app.survey'),
        ),
        migrations.AddField(
            model_name='answer',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tpm777app_answers', to=settings.AUTH_USER_MODEL),
        ),
    ]
