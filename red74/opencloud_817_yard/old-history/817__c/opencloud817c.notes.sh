...
d1=/ap/dkr/732collection/red74/opencloud_817_yard/817__c/opencloud817c;
mkdir -p $d1;

# d2=/ap/dkr/732collection/red74/opencloud_817_yard/817__c/sysdata;
# mkdir -p $d2;
...
services:
  opencloud817c:
    ...
    environment:
      ...
      OC_INSECURE: "true"
    volumes:
      - /ap/dkr/732collection/red74/opencloud_817_yard/817__c/opencloud817c/sysdata/opencloud-config:/etc/opencloud
      - /ap/dkr/732collection/red74/opencloud_817_yard/817__c/opencloud817c/sysdata/opencloud-data:/var/lib/opencloud
